...
/* harmony import */ var _shared_services_interceptor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/services/interceptor.service */ "./src/app/shared/services/interceptor.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _shared_services_interceptor_service__WEBPACK_IMPORTED_MODULE_10__["InterceptorService"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: ngx_progressbar__WEBPACK_IMPORTED_MODULE_4__["NgProgressInterceptor"], multi: true }
            ],
...
/* harmony import */ var _modules_auth_shared_service_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../modules/auth/shared/service/auth.service */ "./src/app/modules/auth/shared/service/auth.service.ts");
...
var InterceptorService = /** @class */ (function () {
    function InterceptorService(toastr, auth) {
        this.toastr = toastr;
        this.auth = auth;
    }
    InterceptorService.prototype.intercept = function (req, next) {
        ...
        var _a;
        req = req.clone({
            url: _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiBaseUrl + req.url,
            setHeaders: (_a = {},
                _a['Content-Type'] = "application/json",
                _a)
        });
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (event) {
            ...
            if (error.error.error) {
                _this.toastr.error(error.error.error.message.split(';').join('\n'), error.error.error.name);
    ...
    InterceptorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"],
            _modules_auth_shared_service_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"]])
    ], InterceptorService);
...
module.exports = __webpack_require__(/*! /home/shreydev/Documents/Frontend-Test-Project/client/src/main.ts */"./src/main.ts");
