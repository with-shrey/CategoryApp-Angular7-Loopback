...
/* harmony import */ var _sub_category_edit_sub_category_edit_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sub-category-edit/sub-category-edit.component */ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.ts");
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: ':id/:subid/edit',
                component: _sub_category_edit_sub_category_edit_component__WEBPACK_IMPORTED_MODULE_7__["SubCategoryEditComponent"],
            }
        ]
    }
];
...
/* harmony import */ var _sub_category_sub_category_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./sub-category/sub-category.component */ "./src/app/modules/categories/sub-category/sub-category.component.ts");
/* harmony import */ var _sub_category_add_sub_category_add_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./sub-category-add/sub-category-add.component */ "./src/app/modules/categories/sub-category-add/sub-category-add.component.ts");
/* harmony import */ var _sub_category_edit_sub_category_edit_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./sub-category-edit/sub-category-edit.component */ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.ts");
...
var CategoryEditComponent = /** @class */ (function () {
    ...
    CategoryEditComponent.prototype.ngOnInit = function () {
        ...
        this.crum.setBreadcrum([
            ...
            new _shared_model_breadcrum__WEBPACK_IMPORTED_MODULE_5__["Breadcrum"]('' + this.id, "/" + this.id + "/list"),
...
module.exports = ".list-container {\n  height: 78vh;\n  overflow-y: auto; }\n\n.subcat {\n  margin-left: 20px;\n  margin-right: 10px;\n  margin-bottom: 5px; }\n\n.hint {\n  color: #ccca61;\n  font-size: small; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CategoryListComponent = /** @class */ (function () {
    function CategoryListComponent(service, toastr, crum, route) {
        this.service = service;
        this.toastr = toastr;
        this.crum = crum;
        this.route = route;
...
/***/ "./src/app/modules/categories/shared/model/subcategory/subcategory.ts":
/*!****************************************************************************!*\
  !*** ./src/app/modules/categories/shared/model/subcategory/subcategory.ts ***!
  \****************************************************************************/
...
/***/ "./src/app/modules/categories/shared/service/sub-category.service.ts":
/*!***************************************************************************!*\
  !*** ./src/app/modules/categories/shared/service/sub-category.service.ts ***!
  \***************************************************************************/
...
var SubcategoryService = /** @class */ (function () {
    function SubcategoryService(http) {
        this.http = http;
        this._subcategory = 'Sub-categories';
        this.limit = 10;
    }
    SubcategoryService.prototype.getSubcategory = function (id) {
        return this.http.get(this._subcategory + "/" + id);
    };
    SubcategoryService.prototype.getSubcategories = function (id) {
        var filter = "{\"categoryId\":" + id + "}";
        return this.http.get(this._subcategory + "?filter=" + encodeURIComponent(filter));
    };
    SubcategoryService.prototype.addSubcategory = function (subcategory) {
        var id = subcategory.id, rest = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](subcategory, ["id"]);
        return this.http.post(this._subcategory, rest);
    };
    SubcategoryService.prototype.updateSubcategory = function (subcategory) {
        return this.http.put(this._subcategory, subcategory);
    };
    SubcategoryService.prototype.deleteSubcategory = function (subcategory) {
        return this.http.delete(this._subcategory + "/" + subcategory.id);
    };
...
/***/ "./src/app/modules/categories/sub-category-add/sub-category-add.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-add/sub-category-add.component.html ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12\">\n    <div class=\"card\">\n      <div class=\"card-content\">\n        <span (click)=\"enableAdd()\" *ngIf=\"!addMode\" class=\"card-title\"><i class=\"material-icons prefix\">add</i> Add subcategory</span>\n        <i *ngIf=\"addMode\" (click)=\"addMode = false\"  class=\"material-icons prefix\">close</i>\n        <div *ngIf=\"addMode\" class=\"row\">\n          <form class=\"col s12\" (ngSubmit)=\"addCategory()\">\n            <div class=\"row\">\n              <div class=\"input-field col s12\">\n                <input id=\"name\" type=\"text\" name=\"name\" class=\"validate\" [(ngModel)]=\"subcategory.name\" required>\n                <label for=\"name\">Name</label>\n              </div>\n            </div>\n            <div class=\"row\">\n              <div class=\"input-field col s12\">\n                <textarea id=\"textarea1\" class=\"materialize-textarea\" name=\"description\" [(ngModel)]=\"subcategory.description\" required></textarea>\n                <label for=\"textarea1\">Description</label>\n              </div>\n            </div>\n            <div class=\"row\">\n              <input class=\"buttons\" type=\"submit\" value=\"Submit\"/>\n            </div>\n          </form>\n        </div>\n\n      </div>\n\n    </div>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/modules/categories/sub-category-add/sub-category-add.component.scss":
/*!*************************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-add/sub-category-add.component.scss ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY2F0ZWdvcmllcy9zdWItY2F0ZWdvcnktYWRkL3N1Yi1jYXRlZ29yeS1hZGQuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/modules/categories/sub-category-add/sub-category-add.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-add/sub-category-add.component.ts ***!
  \***********************************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _shared_model_subcategory_subcategory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/model/subcategory/subcategory */ "./src/app/modules/categories/shared/model/subcategory/subcategory.ts");
/* harmony import */ var _shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/service/sub-category.service */ "./src/app/modules/categories/shared/service/sub-category.service.ts");
...
var SubCategoryAddComponent = /** @class */ (function () {
    function SubCategoryAddComponent(service, toastr) {
        this.service = service;
        this.toastr = toastr;
        this.addMode = false;
        this.categoryAdded = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    SubCategoryAddComponent.prototype.enableAdd = function () {
        this.addMode = true;
        this.subcategory = new _shared_model_subcategory_subcategory__WEBPACK_IMPORTED_MODULE_3__["Subcategory"]();
        this.subcategory.categoryId = this.categoryId;
        this.subcategory['parent-type'] = 'global';
        this.subcategory.type = '';
    };
    SubCategoryAddComponent.prototype.addCategory = function () {
        var _this = this;
        this.service.addSubcategory(this.subcategory).subscribe(function (subcategory) {
            _this.categoryAdded.emit(subcategory);
            _this.addMode = false;
            _this.toastr.success(subcategory.name, 'Added Successfully');
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)
    ], SubCategoryAddComponent.prototype, "categoryId", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], SubCategoryAddComponent.prototype, "categoryAdded", void 0);
    SubCategoryAddComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sub-category-add',
            template: __webpack_require__(/*! ./sub-category-add.component.html */ "./src/app/modules/categories/sub-category-add/sub-category-add.component.html"),
            styles: [__webpack_require__(/*! ./sub-category-add.component.scss */ "./src/app/modules/categories/sub-category-add/sub-category-add.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_4__["SubcategoryService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"]])
...
/***/ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.html":
/*!***************************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-edit/sub-category-edit.component.html ***!
  \***************************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"row\">\n  <form class=\"col s6 offset-s3\" (ngSubmit)=\"updateCategory()\">\n    <div class=\"row\">\n      <div class=\"input-field col s12\">\n        <input id=\"catid\" type=\"number\" name=\"category_id\" class=\"validate\" [(ngModel)]=\"category.categoryId\" required>\n        <label class=\"active\" for=\"catid\">Category ID</label>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"input-field col s12\">\n        <input id=\"name\" type=\"text\" name=\"name\" class=\"validate\" [(ngModel)]=\"category.name\" required>\n        <label class=\"active\" for=\"name\">Name</label>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"input-field col s12\">\n        <textarea id=\"textarea1\" class=\"materialize-textarea\" name=\"description\" [(ngModel)]=\"category.description\" required></textarea>\n        <label class=\"active\" for=\"textarea1\">Description</label>\n      </div>\n    </div>\n    <div class=\"row\">\n      <input class=\"buttons\" type=\"submit\" value=\"Submit\"/>\n    </div>\n  </form>\n</div>\n"

/***/ }),

/***/ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.scss":
/*!***************************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-edit/sub-category-edit.component.scss ***!
  \***************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY2F0ZWdvcmllcy9zdWItY2F0ZWdvcnktZWRpdC9zdWItY2F0ZWdvcnktZWRpdC5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category-edit/sub-category-edit.component.ts ***!
  \*************************************************************************************/
/*! exports provided: SubCategoryEditComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubCategoryEditComponent", function() { return SubCategoryEditComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_service_breadcrum_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../shared/service/breadcrum.service */ "./src/app/shared/service/breadcrum.service.ts");
/* harmony import */ var _shared_model_breadcrum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/model/breadcrum */ "./src/app/shared/model/breadcrum.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _shared_model_subcategory_subcategory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/model/subcategory/subcategory */ "./src/app/modules/categories/shared/model/subcategory/subcategory.ts");
/* harmony import */ var _shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../shared/service/sub-category.service */ "./src/app/modules/categories/shared/service/sub-category.service.ts");
...
var SubCategoryEditComponent = /** @class */ (function () {
    function SubCategoryEditComponent(service, toastr, crum, route, router) {
        this.service = service;
        this.toastr = toastr;
        this.crum = crum;
        this.route = route;
        this.router = router;
        this.category = new _shared_model_subcategory_subcategory__WEBPACK_IMPORTED_MODULE_6__["Subcategory"]();
    }
    SubCategoryEditComponent.prototype.ngOnInit = function () {
        ...
        this.crum.setBreadcrum([
            new _shared_model_breadcrum__WEBPACK_IMPORTED_MODULE_3__["Breadcrum"]('Category' + this.id, "/" + this.id + "/edit"),
            new _shared_model_breadcrum__WEBPACK_IMPORTED_MODULE_3__["Breadcrum"]('SubCategory' + this.subcatid, "/" + this.id),
            new _shared_model_breadcrum__WEBPACK_IMPORTED_MODULE_3__["Breadcrum"]('Edit', '#'),
        ]);
        this.service.getSubcategory(this.subcatid).subscribe(function (category) { return _this.category = category; });
    };
    SubCategoryEditComponent.prototype.updateCategory = function () {
        var _this = this;
        this.service.updateSubcategory(this.category)
            .subscribe(function (category) {
            _this.toastr.success(category.name, 'Updated Successfully');
            _this.router.navigate(["/" + _this.id]);
        });
    };
    SubCategoryEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sub-category-edit',
            template: __webpack_require__(/*! ./sub-category-edit.component.html */ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.html"),
            styles: [__webpack_require__(/*! ./sub-category-edit.component.scss */ "./src/app/modules/categories/sub-category-edit/sub-category-edit.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_7__["SubcategoryService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"],
            _shared_service_breadcrum_service__WEBPACK_IMPORTED_MODULE_2__["BreadcrumService"],
...
/***/ "./src/app/modules/categories/sub-category/sub-category.component.html":
/*!*****************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category/sub-category.component.html ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "<h5>Subcategories</h5>\n<div *ngIf=\"loading\" class=\"progress\">\n  <div class=\"indeterminate\"></div>\n</div>\n<ul class=\"collection\">\n  <li class=\"collection-item\">\n    <app-sub-category-add (categoryAdded)=\"subCategoryAdded($event)\" [categoryId]=\"categoryId\"></app-sub-category-add>\n  </li>\n  <li class=\"collection-item\" *ngFor=\"let subcat of subcategories\">\n    <div class=\"row\">\n      <div>\n     <h6>{{subcat.name}}</h6>\n     <p>{{subcat.description}}</p>\n    </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col s3 edit\" [routerLink]=\"'/'+categoryId+'/'+subcat.id+'/edit'\">\n        EDIT\n      </div>\n      <div class=\"col s3 delete\" (click)=\"deleteSubCAtegory(subcat)\">\n        DELETE\n      </div>\n    </div>\n  </li>\n</ul>\n"

/***/ }),

/***/ "./src/app/modules/categories/sub-category/sub-category.component.scss":
/*!*****************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category/sub-category.component.scss ***!
  \*****************************************************************************/
/*! no static exports found */
...
module.exports = "h5 {\n  color: white; }\n\n.edit {\n  color: #4192ff; }\n\n.delete {\n  color: #ff693d; }\n\nh6 {\n  color: #454545; }\n\n.loader {\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/modules/categories/sub-category/sub-category.component.ts":
/*!***************************************************************************!*\
  !*** ./src/app/modules/categories/sub-category/sub-category.component.ts ***!
  \***************************************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/service/sub-category.service */ "./src/app/modules/categories/shared/service/sub-category.service.ts");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
...
var SubCategoryComponent = /** @class */ (function () {
    function SubCategoryComponent(service, toastr) {
        this.service = service;
        this.toastr = toastr;
    }
    SubCategoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
        this.service.getSubcategories(this.categoryId).subscribe(function (subcat) {
            _this.subcategories = subcat;
            _this.loading = false;
        }, function (err) {
            _this.loading = false;
        });
    };
    SubCategoryComponent.prototype.deleteSubCAtegory = function (subcategory) {
        var _this = this;
        this.service.deleteSubcategory(subcategory).subscribe(function (deleted) {
            var index = _this.subcategories.indexOf(subcategory); // <-- Not supported in <IE9
            if (index !== -1) {
    ...
    SubCategoryComponent.prototype.editSubcategory = function (subcat) {
    };
    SubCategoryComponent.prototype.subCategoryAdded = function (sub) {
        this.subcategories.push(sub);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)
    ], SubCategoryComponent.prototype, "categoryId", void 0);
    SubCategoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-sub-category',
            template: __webpack_require__(/*! ./sub-category.component.html */ "./src/app/modules/categories/sub-category/sub-category.component.html"),
            styles: [__webpack_require__(/*! ./sub-category.component.scss */ "./src/app/modules/categories/sub-category/sub-category.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_shared_service_sub_category_service__WEBPACK_IMPORTED_MODULE_2__["SubcategoryService"],
            ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]])
